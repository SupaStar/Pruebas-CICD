...
const successData = {
  token:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsInVzZXIiOiJqb2huZCIsImlhdCI6MTc0Nzg4MTg3Mn0.y0ddM5YIJYnlaxvE4MwbjUQBeYOGQ349Qs9_MWdDMYg',
}
...
describe('LoginService', () => {
  ...
  test('debe rechazar cuando se envían credenciales incorrectas', async () => {
    ...
    await expect(
      LoginService(invalidUsername, invalidPassword),
