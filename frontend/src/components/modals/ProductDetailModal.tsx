...
import { Dialog, Flex, Text, Avatar, Heading, Spinner } from "@radix-ui/themes"
            ...
            <Dialog.Content maxWidth="450px">
                ...
                {loading ? (
                    ...
                    <Flex direction="column" gap="4">
                        ...
                        <Text><strong>Precio:</strong> ${product.price}</Text>
                        <Text><strong>Descripción:</strong> {product.description}</Text>
